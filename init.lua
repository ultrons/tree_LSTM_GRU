...
--include('models/TreeGRU/GRU.lua')
include('models/TreeGRU/TreeGRU.lua')
--include('models/TreeGRU/ChildSumTreeGRU.lua')
include('models/TreeGRU/BinaryTreeGRU.lua')
include('models/TreeLSTM/LSTM.lua')
include('models/TreeLSTM/TreeLSTM.lua')
include('models/TreeLSTM/ChildSumTreeLSTM.lua')
include('models/TreeLSTM/BinaryTreeLSTM.lua')
